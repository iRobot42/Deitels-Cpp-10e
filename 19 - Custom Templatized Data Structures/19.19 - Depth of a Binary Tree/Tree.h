...
class Tree {
   ...
   int calculateDepthHelper( Node* ptr ) const {

      if ( !ptr ) return Type();
      int lDepth{ calculateDepthHelper( ptr->left ) };
      int rDepth{ calculateDepthHelper( ptr->right ) };
...
public:
   ...
   int calculateDepth() const      { return calculateDepthHelper( root ); }
};
